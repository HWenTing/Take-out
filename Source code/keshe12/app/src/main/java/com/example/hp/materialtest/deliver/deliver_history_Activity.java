...
public class deliver_history_Activity extends AppCompatActivity {

    private DrawerLayout mDrawerLayout;
    private List<deliver_order_Item> morderList=new ArrayList<>();
    private deliver_historyItem_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v,"Data deleted",Snackbar.LENGTH_SHORT).setAction("undo", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(deliver_history_Activity.this,"Data ",Toast.LENGTH_SHORT).show();
                    }
                }).show();
            }
        });
        ...
        adapter=new deliver_historyItem_Adapter(morderList);
    ...
    private int  initOrders(){
        ...
        Request request = new Request.Builder()
                .url("http://10.0.2.2:8080/DBDesign/db/getfinishedOrder_deliver.action")
                .post(requestBody)
                .build();
