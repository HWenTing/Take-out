...
public class shop_manage_waitDeliver_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_order_waitdeliver);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v,"Data deleted",Snackbar.LENGTH_SHORT).setAction("undo", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(shop_manage_waitDeliver_Activity.this,"Data ",Toast.LENGTH_SHORT).show();
                    }
                }).show();
            }
        });
    ...
    private int  initOrders(){
        ...
        Request request = new Request.Builder()
                .url("http://10.0.2.2:8080/DBDesign/db/getWaitDeliverOrder.action")
                .post(requestBody)
                .build();
