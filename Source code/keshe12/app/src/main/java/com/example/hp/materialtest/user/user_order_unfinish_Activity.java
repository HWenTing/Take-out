...
public class user_order_unfinish_Activity extends AppCompatActivity {

    private DrawerLayout mDrawerLayout;
    private List<user_OrderItem> morderList=new ArrayList<>();
    private user_Order_unfinish_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_order_unfinish);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v,"Data deleted",Snackbar.LENGTH_SHORT).setAction("undo", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(user_order_unfinish_Activity.this,"Data ",Toast.LENGTH_SHORT).show();
                    }
                }).show();
            }
        });
        ...
        adapter=new user_Order_unfinish_Adapter(morderList);
...
//        });
    ...
    private boolean initOrders(){
        ...
        Request request = new Request.Builder()
                .url("http://10.0.2.2:8080/DBDesign/db/getunfinishOrder_user.action")
                .post(requestBody)
                .build();
