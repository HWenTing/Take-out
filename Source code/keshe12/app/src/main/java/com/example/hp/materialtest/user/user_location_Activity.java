...
public class user_location_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_location_);
    ...
    private void initClick() {
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                System.out.println(spinner_sheng.getSelectedItem().toString());
                Log.d("aa",spinner_sheng.getSelectedItem().toString());
                ...
                Request request = new Request.Builder()
                        .url("http://10.0.2.2:8080/DBDesign/db/set_user_location.action")
                        .post(requestBody)
                        .build();
                String response = MyRequest.sendRequestWithOkHttp(request);
                if(response.equals("success")){
                    Toast.makeText(user_location_Activity.this,"位置信息更改成功",Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(user_location_Activity.this,UserMainActivity.class);
                    intent.putExtra("input_account",input_account);
                    startActivity(intent);
                }else{
                    Toast.makeText(user_location_Activity.this, "位置信息更改失败", Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(user_location_Activity.this,UserMainActivity.class);
                    intent.putExtra("input_account",input_account);
                    startActivity(intent);
                }
