...
public class shop_comment_Activity extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v,"Data deleted",Snackbar.LENGTH_SHORT).setAction("undo", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(shop_comment_Activity.this,"Data ",Toast.LENGTH_SHORT).show();
                    }
                }).show();
            }
        });
    ...
    private double  initOrders(){
        ...
        Request request = new Request.Builder()
                .url("http://10.0.2.2:8080/DBDesign/db/shop_comments_from_user.action")
                .post(requestBody)
                .build();
