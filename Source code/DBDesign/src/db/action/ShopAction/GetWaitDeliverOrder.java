...
public class GetWaitDeliverOrder  extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		Map<String,Object> result=orderService.getWaitDeliverOrder(shop_name);
