...
public class GetWaitFinishOrder  extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		Map<String,Object> result=orderService.getWaitFinishOrder(shop_name);
