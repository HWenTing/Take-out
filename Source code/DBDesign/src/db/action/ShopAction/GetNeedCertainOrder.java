...
public class GetNeedCertainOrder extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		Map<String,Object> result=orderService.getNeedCertainOrder(shop_name);
