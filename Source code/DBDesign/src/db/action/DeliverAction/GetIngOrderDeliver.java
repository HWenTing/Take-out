...
public class GetIngOrderDeliver  extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		Map<String,Object> result=orderService.getWaitFinishOrder_deliver(deliver_name);
